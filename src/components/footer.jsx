			...
			<div className="w-full max-w-[1600px] pt-12 pb-8 md:px-8 md:pt-16 md:max-w-[1228px] lg:px-12 lg:pt-20 lg:max-w-[1600px]">
				...
				<div className="flex flex-col gap-4 mt-12">
					...
					<p className="text-[0.75rem] leading-5 text-[#5B616E] text-center sm:text-left">
						This is <strong className="text-[#8A919E]">Frema Owusu&apos;s student demo project</strong> built for educational purposes only. It is not affiliated with, endorsed by, or associated with Coinbase, Inc. Do not enter real personal or financial information.
					</p>
